...
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.0.4[2.0.4]
:skaled: https://github.com/skalenetwork/skaled/releases/tag/3.7.5-stable.2[3.7.5-stable.2]
...
:CONTAINER_CONFIGS_STREAM: 2.0.4
