...
:validator-cli: https://github.com/skalenetwork/validator-cli/releases/download/1.3.1/sk-val-1.3.1-Linux-x86_64[1.3.1]
:sgxwallet: https://github.com/skalenetwork/sgxwallet/releases/tag/1.83.0-stable.0[1.83.0-stable.0]
:sgxwallet-container: skalenetwork/sgxwallet_release:1.83.0-stable.0
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.1.0-testnet.0[2.1.0-testnet.0]
:skaled: https://github.com/skalenetwork/skaled/releases/tag/3.14.9-stable.0[3.14.9-stable.0]
:ima: https://github.com/skalenetwork/IMA/releases/tag/1.1.2-beta.0[1.1.2-beta.0]
