...
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.1.8[2.1.8]
:skaled: https://github.com/skalenetwork/skaled/releases/tag/3.14.9-stable.5.1.hotfix[3.14.9-stable.5.1.hotfix]
...
:CONTAINER_CONFIGS_STREAM: 2.1.8
