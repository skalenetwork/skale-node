...
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.1.15-staging[2.2.0]
...
:skale-admin: https://github.com/skalenetwork/skale-admin/releases/tag/2.4.0[2.5.0]
