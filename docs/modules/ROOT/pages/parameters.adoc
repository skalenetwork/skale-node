...
// skale software
:node-cli: https://github.com/skalenetwork/node-cli/releases/download/2.0.1/skale-2.0.1-Linux-x86_64[2.0.1]
...
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.0.0[2.0.0]
...
:transaction-manager: https://github.com/skalenetwork/transaction-manager/releases/tag/2.0.1[2.0.1]
:skale-admin: https://github.com/skalenetwork/skale-admin/releases/tag/2.0.1[2.0.1]
:bounty-agent: https://github.com/skalenetwork/bounty-agent/releases/tag/2.0.1-stable.0[2.0.1-stable.0]
:skale-watchdog: https://github.com/skalenetwork/skale-watchdog/releases/tag/2.0.0-stable.0[2.0.0-stable.0]
