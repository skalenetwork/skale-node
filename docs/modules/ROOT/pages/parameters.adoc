...
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.1.7[2.1.7]
:skaled: https://github.com/skalenetwork/skaled/releases/tag/3.14.9-stable.5[3.14.9-stable.5]
...
:CONTAINER_CONFIGS_STREAM: 2.1.7
