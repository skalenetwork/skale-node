...
:validator-cli: https://github.com/skalenetwork/validator-cli/releases/download/1.3.0/sk-val-1.3.0-Linux-x86_64[1.3.0]
:sgxwallet: https://github.com/skalenetwork/sgxwallet/releases/tag/1.77.1-stable.3[1.77.1-stable.3]
:sgxwallet-container: skalenetwork/sgxwallet_release:1.77.1-stable.3
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.0.3-testnet.1[2.0.3-testnet.1]
:skaled: https://github.com/skalenetwork/skaled/releases/tag/3.7.5-beta.7[3.7.5-beta.7]
:ima: https://github.com/skalenetwork/IMA/releases/tag/1.0.0-stable.1[1.0.0-stable.1]
...
:bounty-agent: https://github.com/skalenetwork/bounty-agent/releases/tag/2.0.2[2.0.2]
...
:CONTAINER_CONFIGS_STREAM: 2.0.3-testnet.1 
