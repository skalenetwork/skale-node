...
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.1.3[2.1.3]
:skaled: https://github.com/skalenetwork/skaled/releases/tag/3.14.9-stable.3[3.14.9-stable.3]
...
:transaction-manager: https://github.com/skalenetwork/transaction-manager/releases/tag/2.1.1[2.1.1]
:skale-admin: https://github.com/skalenetwork/skale-admin/releases/tag/2.3.2[2.3.2]
...
:CONTAINER_CONFIGS_STREAM: 2.1.3
