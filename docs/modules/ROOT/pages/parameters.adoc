...
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.0.1-testnet.0[2.0.1-testnet.1]
...
:skale-admin: https://github.com/skalenetwork/skale-admin/releases/tag/2.0.1-beta.6[2.0.1-beta.7]
