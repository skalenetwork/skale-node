...
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.1.15[2.1.15]
:skaled: https://github.com/skalenetwork/skaled/releases/tag/3.16.0-stable.3[3.16.0-stable.3]
:ima: https://github.com/skalenetwork/IMA/releases/tag/1.5.0-beta.1[1.5.0-beta.1]
...
:CONTAINER_CONFIGS_STREAM: 2.1.15
