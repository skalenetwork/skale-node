...
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.1.10[2.1.10]
:skaled: https://github.com/skalenetwork/skaled/releases/tag/3.14.15-stable.1[3.14.15-stable.1]
...
:skale-admin: https://github.com/skalenetwork/skale-admin/releases/tag/2.3.8[2.3.8]
