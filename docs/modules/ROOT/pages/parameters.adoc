...
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.1.0-testnet.1[2.1.0-testnet.1]
:skaled: https://github.com/skalenetwork/skaled/releases/tag/3.14.9-stable.1[3.14.9-stable.1]
:ima: https://github.com/skalenetwork/IMA/releases/tag/1.1.4-beta.1[1.1.4-beta.1]
...
:CONTAINER_CONFIGS_STREAM: 2.1.0-testnet.1
