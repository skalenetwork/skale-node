...
:skale-node: https://github.com/skalenetwork/skale-node/releases/tag/2.1.6[2.1.6]
...
:skale-admin: https://github.com/skalenetwork/skale-admin/releases/tag/2.3.3[2.3.3]
...
:CONTAINER_CONFIGS_STREAM: 2.1.6
