...
Please run following commands on the machine to prune the old testnet node data:
...
Please follow the updated xref:setup-process.adoc[Setup process] doc to setup a node connected to test SKALE Network infrastructure which connected to Goerli.
