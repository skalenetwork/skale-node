...
[WARNING]
Complience requirements will be checked during upgrade.
...
[NOTE]
If upgrade fails with `Host is not fully meet the requirements` please visit xref:compliance-requirements.adoc[Complience requirements]. 
